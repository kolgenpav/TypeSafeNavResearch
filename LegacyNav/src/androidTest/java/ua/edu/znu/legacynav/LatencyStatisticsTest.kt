...
class LatencyStatisticsTest {
    ...
    fun meanLatencies_over10Runs() {
        ...
        Log.i("LatencyStats", "")
        Log.i("LatencyStats", "Setup (FirstFragment):")
        Log.i("LatencyStats", "  Mean:          ${stats.meanSetupLatency.nanoseconds}")
        Log.i("LatencyStats", "  Std Dev:       ${stats.stdDevSetupLatency.nanoseconds}")
        Log.i("LatencyStats", "  95% CI:        ${stats.ci95LowerSetupLatency.nanoseconds} - ${stats.ci95UpperSetupLatency.nanoseconds}")
        Log.i("LatencyStats", "")
        Log.i("LatencyStats", "Framework Routing:")
        Log.i("LatencyStats", "  Mean:          ${stats.meanFrameworkRoutingLatency.nanoseconds}")
        Log.i("LatencyStats", "  Std Dev:       ${stats.stdDevFrameworkRoutingLatency.nanoseconds}")
        Log.i("LatencyStats", "  95% CI:        ${stats.ci95LowerFrameworkRoutingLatency.nanoseconds} - ${stats.ci95UpperFrameworkRoutingLatency.nanoseconds}")
        Log.i("LatencyStats", "")
        Log.i("LatencyStats", "Data Retrieval:")
        Log.i("LatencyStats", "  Mean:          ${stats.meanObjectRetrievalLatency.nanoseconds}")
        Log.i("LatencyStats", "  Std Dev:       ${stats.stdDevObjectRetrievalLatency.nanoseconds}")
        Log.i("LatencyStats", "  95% CI:        ${stats.ci95LowerObjectRetrievalLatency.nanoseconds} - ${stats.ci95UpperObjectRetrievalLatency.nanoseconds}")
        Log.i("LatencyStats", "")
        Log.i("LatencyStats", "Screen Render:")
        Log.i("LatencyStats", "  Mean:          ${stats.meanScreenRenderLatency.nanoseconds}")
        Log.i("LatencyStats", "  Std Dev:       ${stats.stdDevScreenRenderLatency.nanoseconds}")
        Log.i("LatencyStats", "  95% CI:        ${stats.ci95LowerScreenRenderLatency.nanoseconds} - ${stats.ci95UpperScreenRenderLatency.nanoseconds}")
    }
}
